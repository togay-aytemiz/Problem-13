...
export default function PersonalInfo() {
  ...
  const [timezone, setTimezone] = useState("pasifik");

  const getTimeZoneDetails = (timezone) => {
    if (timezone === "pasifik") {
      return "Pasifik Standart Saati";
    } else if (timezone === "doğu") {
      return "  Doğu Standart Saati";
    } else {
      return "Greenwich Ortalama Saati";
    }
  };
          ...
          <div className="grid grid-cols-1 gap-x-6 gap-y-8 sm:max-w-xl sm:grid-cols-6">
            ...
            <div className="col-span-full">
              ...
              <div className="mt-2">
                ...
                >
                  <option value={"pasifik"}>Pasifik Standart Saati</option>
                  <option value={"doğu"}>Doğu Standart Saati</option>
                  <option value={"greenwich"}>Greenwich Ortalama Saati</option>
                </select>
              </div>
            </div>
          </div>
